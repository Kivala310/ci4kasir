    ...
    $(document).ready(function() {
            ...
            if (hasil.status === 'success') {
              ...
              produk.forEach(function(item) {
                var row = '<tr>' +
                  ...
                  '<td>' + item.stok + '</td>' +
                  '<td>' +
                  '<button class="btn btn-warning btn-sn editProduk" data-bs-toggle="modal" data-bs-target="#modalEditProduk" data-id="' + item.produk_id + '"><i class="fa-solid fa-pencil"></i> Edit</button>' +
      ...
      $("#produkTable").on('click', '.hapusProduk', function() {
        ...
        $("#produkTable").on('click', '.editProduk', function() {
          var produkId = $(this).data('id'); // Mengambil produk_id dari tombol edit'
